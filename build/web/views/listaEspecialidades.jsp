...
<div class="page">
    ...
    <main>
        ...
        if ((msgOperacaoRealizada != null) && (!msgOperacaoRealizada.isEmpty())) {%>
                ...
                <a href="especialidade?acao=Incluir" class="mb-2 btn btn-primary">Incluir</a>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <%
                                ...
                                for (Especialidade paciente : listaEspecialidades) {
                                    out.println("<tr>");
                                    out.println("<th>" + paciente.getId() + "</th>");
                                    out.println("<td>" + paciente.getDescricao() + "</td>");%>
                            <td><a href="especialidade?acao=Alterar&id=<%=paciente.getId()%>"
                                    class="btn btn-warning">Alterar</a>
                                <a href="especialidade?acao=Excluir&id=<%=paciente.getId()%>"
